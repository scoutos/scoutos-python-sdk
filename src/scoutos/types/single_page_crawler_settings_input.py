...
class SinglePageCrawlerSettingsInput(UncheckedBaseModel):
    scraper: typing.Optional[SinglePageCrawlerSettingsInputScraper] = None
    text_extractor: typing.Optional[SinglePageCrawlerSettingsInputTextExtractor] = None
