...
class SitemapCrawlerSettingsInput(UncheckedBaseModel):
    scraper: typing.Optional[SitemapCrawlerSettingsInputScraper] = None
    text_extractor: typing.Optional[SitemapCrawlerSettingsInputTextExtractor] = None
