...
class CollectionConfigOutputColumnsItem_Boolean(UncheckedBaseModel):
...
class CollectionConfigOutputColumnsItem_Json(UncheckedBaseModel):
...
class CollectionConfigOutputColumnsItem_Number(UncheckedBaseModel):
...
class CollectionConfigOutputColumnsItem_Select(UncheckedBaseModel):
...
class CollectionConfigOutputColumnsItem_TextLong(UncheckedBaseModel):
...
class CollectionConfigOutputColumnsItem_TextShort(UncheckedBaseModel):
...
CollectionConfigOutputColumnsItem = typing_extensions.Annotated[
    typing.Union[
    ...
    UnionMetadata(discriminant="column_type"),
]
