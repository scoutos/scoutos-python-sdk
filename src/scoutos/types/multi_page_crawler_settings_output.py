...
class MultiPageCrawlerSettingsOutput(UncheckedBaseModel):
    scraper: typing.Optional[MultiPageCrawlerSettingsOutputScraper] = None
    text_extractor: typing.Optional[MultiPageCrawlerSettingsOutputTextExtractor] = None
