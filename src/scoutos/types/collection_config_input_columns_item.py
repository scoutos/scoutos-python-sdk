...
class CollectionConfigInputColumnsItem_Boolean(UncheckedBaseModel):
...
class CollectionConfigInputColumnsItem_Json(UncheckedBaseModel):
...
class CollectionConfigInputColumnsItem_Number(UncheckedBaseModel):
...
class CollectionConfigInputColumnsItem_Select(UncheckedBaseModel):
...
class CollectionConfigInputColumnsItem_TextLong(UncheckedBaseModel):
...
class CollectionConfigInputColumnsItem_TextShort(UncheckedBaseModel):
...
CollectionConfigInputColumnsItem = typing_extensions.Annotated[
    typing.Union[
