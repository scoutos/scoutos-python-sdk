...
class CollectionConfigInputColumnsItem_Boolean(UniversalBaseModel):
...
class CollectionConfigInputColumnsItem_Json(UniversalBaseModel):
...
class CollectionConfigInputColumnsItem_Number(UniversalBaseModel):
...
class CollectionConfigInputColumnsItem_Select(UniversalBaseModel):
...
class CollectionConfigInputColumnsItem_TextLong(UniversalBaseModel):
...
class CollectionConfigInputColumnsItem_TextShort(UniversalBaseModel):
...
CollectionConfigInputColumnsItem = typing.Union[
